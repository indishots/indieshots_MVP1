...
Recent Changes:
- July 4, 2025: **PREMIUM DEMO ACCOUNT FIXED** - Resolved issue where premium@demo.com wasn't showing as premium account; added special handling in Firebase sync controller to preserve pro tier for demo account; implemented JWT token generation override to force pro tier values (unlimited pages, unlimited shots, storyboard generation) regardless of database state; premium@demo.com now permanently treated as pro tier account for testing and demonstration purposes
