...
Recent Changes:
- July 3, 2025: **FREE TIER STORYBOARD ACCESS ENABLED** - Removed storyboard generation restrictions for free tier users; updated all tier management systems to allow storyboard generation for all users; updated 58 existing free tier user records in database to enable storyboard access; eliminated red upgrade popup that was blocking free users from generating storyboards; free tier users now have full access to storyboard generation features
