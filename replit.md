...
Recent Changes:
- July 3, 2025: **PROMO CODE TIER UPGRADE SYSTEM FIXED** - Resolved critical issue where users signing up with promo codes weren't getting pro tier benefits; fixed PromoCodeService to properly update users table with tier='pro' when promo codes are applied; updated varshithakommuri04@gmail.com from free to pro tier; all future promo code users will now automatically receive correct tier privileges without manual intervention
