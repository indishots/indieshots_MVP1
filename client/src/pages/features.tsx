      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Feature Card 1 */}
            <div className="group relative bg-gradient-to-br from-indigo-200/60 to-amber-100/50 border border-indigo-300/60 p-8 rounded-2xl hover:shadow-xl hover:shadow-indigo-300/50 transition-all duration-300 hover:-translate-y-1">
              <div className="absolute top-6 right-6 opacity-20 group-hover:opacity-40 transition-opacity duration-300">
                <div className="w-16 h-16 bg-gradient-to-br from-indigo-300/70 to-amber-300/60 rounded-full shadow-lg"></div>
              </div>
